...
import SingleSideItem from "../components/shared/SingleSideItem";
import index from "../app/login/page";
    ...
    <div className="grid grid-cols-6 min-h-max">
      <div className="col-span-1 flex flex-col h-full gap-2 my-4 w-full">
        {SideBarItems.map((el, index) => {
          return <SingleSideItem content={el} key={index * 10000} />;
        })}

        <div className="cursor-pointer absolute px-12 py-4 bottom-10 left-20 flex items-center gap-4 group text-[#696F79] hover:text-white hover:bg-[#8692A6] hover:rounded-full">
          <span>
            <svg
              width="21"
              height="25"
